...
{
    Task<IEnumerable<ActionDto>> GetActionsAsync(CancellationToken cancellationToken);
    ...
    Task<ActionDto> AddOrUpdateResultAsync(Guid actionId, Guid raceId, Guid categoryId, ResultDto result, CancellationToken cancellationToken);
